...
Here are some visualizations of data from our dataset, and an example of a conversion from the cosmic ray event on the HAWC grid to the data we generate.

<img src="./plots/ground_truth/ground_truth_grid.png" width="800px"/>

<img src="./plots/ground_truth/single_ground_truth.png" width="400px"/> <img src="./plots/ground_truth/single_ground_truth_pmts.png" width="400px"/>
...
<img src="./plots/pixelcnn/pixelcnn_grid.png" width="800px"/>
...
<img src="./plots/pixelcnn/pixelcnn_grid_fast.png" width="800px"/>
...
Here are visualizations of a PixelCNN model conditioned on `rec.azimuth` for the values `0.0` and `3.0` respectively, where we cherry picked large events for clarity. Azimuth represents the angle that the cosmic ray shower crosses the grid, and we see the effect clearly in the time channel, where all events with the same `rec.azimuth` value have the same gradient.

<img src="./plots/pixelcnn/pixelcnn_grid_azimuth_0.png" width="800px"/>

<img src="./plots/pixelcnn/pixelcnn_grid_azimuth_3.png" width="800px"/>
